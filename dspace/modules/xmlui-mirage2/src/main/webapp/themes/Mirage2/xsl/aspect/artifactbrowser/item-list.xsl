    ...
    <xsl:template match="dim:dim" mode="itemSummaryList-DIM-metadata">
        ...
        <div class="artifact-description">
            ...
            <div class="artifact-info">
				...
				<xsl:variable name="author-string" select="encoder:encode(node())"/>
                                <span>
            ...
            <xsl:if test="dim:field[@element = 'type']">
                <xsl:variable name="iType" select="dim:field[@element = 'type']/node()"/>
                <div class="artifact-type">
                    <span class="label label-default"><xsl:value-of select="$iType"/></span>
                </div>
            </xsl:if>
