                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{$context-path}/" class="navbar-brand">
                            <img src="{$theme-path}images/aff-logo.png" class="rounded-circle" />
                        </a>
			<div id="header-text">
...
<div class="container" id="aff-dspace-footer">
  <div class="row">
    <div class="col-md-4">
      <div class="card">
        <div class="card-header">
          <h2 class="card-title">About AFF</h2>
        </div>
        <div class="card-body">
          <p>
            The African Forest Forum is an association of individuals with a commitment to the sustainable management, wise use and conservation of Africa’s forest and tree resources for the socio-economic well-being of its peoples and for the stability and improvement of its environment… <a href="http://afforum.org/about/" target="_blank">read more</a>
          </p>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <ul>
            <li>
              <a href="http://afforum.org/" target="_blank"> 
		<span aria-hidden="true" class="glyphicon glyphicon-chevron-right list-icon"></span>Home
	      </a>
            </li>
            <li>
              <a href="http://afforum.org/about/" target="_blank">
		<span aria-hidden="true" class="glyphicon glyphicon-chevron-right list-icon"></span>About
	      </a>
            </li>
            <li>
              <a href="https://afforum.org/our-members" target="_blank">
		<span aria-hidden="true" class="glyphicon glyphicon-chevron-right list-icon"></span>Membership
	      </a>
            </li>
            <li>
              <a href="https://afforum.org/partners" target="_blank">
		<span aria-hidden="true" class="glyphicon glyphicon-chevron-right list-icon"></span>Partners
	      </a>
            </li>
            <li>
              <a href="https://afforum.org/publications" target="_blank">
		<span aria-hidden="true" class="glyphicon glyphicon-chevron-right list-icon"></span>Publications
	      </a>
            </li>
            <li>
              <a href="https://afforum.org/news-events-2" target="_blank">
		<span aria-hidden="true" class="glyphicon glyphicon-chevron-right list-icon"></span>News and Events
	      </a>
            </li>
          </ul>
        </div>
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <p>
            The African Forest Forum,<br />
            United Nations Avenue, <br />
            P.O. Box 30677-00100 <br />
            Nairobi, Kenya<br />
...
<div class="row" style="background:none; background-color: #389a47;">
    <div class="col-md-12">
	<p> Copyright © 2022 African Forest Forum</p>
    </div>
</div>
</div>
